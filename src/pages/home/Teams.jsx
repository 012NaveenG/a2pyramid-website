...
const Teams = () => {
    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-center gap-10">
                {/* Left content */}
                <div className="w-full lg:w-1/2 flex flex-col justify-center">
                    <h1 className="font-bold text-3xl sm:text-5xl lg:text-6xl xl:text-7xl">
                        Meet Our Team That Delivers Your Results
                    </h1>
                    <p className="font-semibold text-sm sm:text-base mt-4 lg:w-[90%]">
                        Our architects, designers, and engineers work together to turn your
                        ideas into powerful software. We use agile methods and clear
                        communication to deliver fast, high-quality results. From concept to
                        ongoing support, we’re committed to your success.
                    </p>
                </div>

                {/* Right content */}
                <div className="w-full lg:w-1/2 flex justify-center gap-10 relative">
